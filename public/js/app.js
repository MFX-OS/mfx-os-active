...
<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px;margin:6px 0">
  <div class="fg" style="margin:0"><label style="font-size:9px;color:var(--tx3)">Cols</label><input data-field="cartonCols" type="number" step="1" value="${f.cartonCols||1}" oninput="asave()" style="width:100%;padding:6px;font-size:11px;background:var(--bg);border:1px solid var(--bdr);border-radius:4px;color:var(--tx)"></div>
  <div class="fg" style="margin:0"><label style="font-size:9px;color:var(--tx3)">Rows</label><input data-field="cartonRows" type="number" step="1" value="${f.cartonRows||1}" oninput="asave()" style="width:100%;padding:6px;font-size:11px;background:var(--bg);border:1px solid var(--bdr);border-radius:4px;color:var(--tx)"></div>
  <div class="fg" style="margin:0"><label style="font-size:9px;color:var(--tx3)">Stacks</label><input data-field="cartonStacks" type="number" step="1" value="${f.cartonStacks||1}" oninput="asave()" style="width:100%;padding:6px;font-size:11px;background:var(--bg);border:1px solid var(--bdr);border-radius:4px;color:var(--tx)"></div>
</div>
